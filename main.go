...
// go ไม่มี contructor function เลยต้องสร้างเอง โดยใช้Function
func NewThaiCitizenService() *ThaiCitizenService {
	fmt.Println("This is manaul constructor")
	return &ThaiCitizenService{}
}

// Validate validate citizen information
// ประกาศให้ function นี้เป็น function ของ ThaiCitizenService ที่เป็น struct
...
// ไม่จำเป็น ต้องประกาศ implement
...
// การประกาศ interface เพื่อใช้ในการทำ unit test ได้ด้วย
